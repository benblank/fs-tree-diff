...
Object.assign(WritableTree.prototype, {
  ...
  _findByRelativePath(relativePath, options) {
    ...
    const index = shared.searchByRelativePath(this._entries, normalizedPath, true);
  ...
  _getEntriesForDirectory(normalizedPath) {
    ...
    let index = shared.searchByRelativePath(this._entries, currentPath.join(path.sep), true);
